...
export default function Hero({ onAddressSubmit }: HeroProps) {
  ...
  return (
    <section
      className="min-h-screen flex flex-col justify-center pt-24 bg-cover bg-center bg-no-repeat relative"
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mb-8">
          ...
          <span className="text-white text-sm font-semibold">500+ Homes Purchased · Licensed &amp; Trusted in MA, NH &amp; RI</span>
        </div>
        ...
        <p className="text-white/80 text-lg sm:text-xl mb-10 max-w-2xl mx-auto leading-relaxed">
          Receive a no-obligation cash offer for your home in Massachusetts, New Hampshire, or Rhode Island.
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto mb-6">
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 z-10 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <AddressAutocomplete
                ...
                inputClassName="w-full pl-12 pr-4 py-4 bg-white rounded-2xl text-gray-800 placeholder-gray-400 text-base focus:outline-none focus:ring-2 focus:ring-brand-gold shadow-lg"
              />
            </div>
            <button
              type="submit"
