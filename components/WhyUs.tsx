    ...
    <section className="bg-gray-50 py-20 lg:py-28">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <p className="text-brand-blue text-sm font-bold tracking-widest uppercase mb-3">Why Sell to Us</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f) => (
            <div key={f.title} className="bg-white rounded-2xl p-7 border border-gray-100 shadow-sm hover:shadow-md hover:border-brand-blue/20 transition-all">
              <div className="w-11 h-11 bg-brand-blue/10 rounded-xl flex items-center justify-center mb-5">
                {f.icon}
              </div>
